...
namespace Tornado14.TrayApp
{
    public partial class ProjectExplorer : Form
    {
        ...
        private void ReadXMLFiles()
        {
            ...
            addNewTasks1.SetProjectBindingSource(projectBindingSource.DataSource);
            addNewTasks1.SetTodoBindingSource(todoBindingSource.DataSource);
            addNewTasks1.SetSprintBindingSource(sprintBindingSource.DataSource);
