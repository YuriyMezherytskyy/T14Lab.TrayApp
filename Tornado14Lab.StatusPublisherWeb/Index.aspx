...
<body>
    ...
    <div>
      Sprint: <asp:label runat="server" text="LabelSprint" ID="LabelSprint" OnLoad="Unnamed1_Load"></asp:label><br/>
      Project: <asp:label runat="server" text="LabelProject" ID ="LabelProject"></asp:label>    
